  ...
  return (
    <div className="bg-card rounded-lg p-6 relative">
      ...
      {(hoveredTrack || playing) && (
        <div
          className="absolute top-2 right-4 py-1.5 px-2 rounded-md shadow-md flex items-center gap-2 transition-all duration-200"
          style={{
            border: '1px solid #1DB954', // Spotify green
            backgroundColor: 'hsla(var(--card), 0.15)', // Subtle background with UI hue
            top: '2.2rem', // Adjust to align with subtitle
        ...
        >
          ...
          {/* Track Details */}
          <div className="text-xs leading-none w-full truncate">
      ...
      <div className="relative">
        ...
        {/* Chart title */}
        <div className="absolute top-2 left-4 space-y-1 mb-10">
          <h3 className="text-lg sm:text-xl font-medium text-foreground">Energy Flow Analysis</h3>
